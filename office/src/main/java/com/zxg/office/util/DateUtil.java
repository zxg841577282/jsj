...
public class DateUtil {
	 ...
	 */
	public static final String DATE_TIME_FORMAT_YYYY = "yyyy年MM月dd日";
	...
	public static boolean validateIsDate(String strTime) {
		...
		if (date != null) {
			System.out.println("生成的日期:"+ parseDateToStr(date, DateUtil.DATE_TIME_FORMAT_YYYY_MM_DD_HH_MI_SS, "--null--"));
			return true;
		}
		return false;
	}
